...
class TricepsWorkout extends StatefulWidget {
  const TricepsWorkout({super.key,required this.appbar});
  final String appbar;
...
class _TricepsWorkoutState extends State<TricepsWorkout> {
  final videourls=[
    ...
    "https://www.youtube.com/shorts/f59wGKbXZ0w",
    "https://www.youtube.com/shorts/YUIUSQG3DvQ",
    "https://www.youtube.com/shorts/8IK6BkC0lWE",
  ];
  @override
